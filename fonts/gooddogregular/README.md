...
import (
  ...
  _ "github.com/gmlewis/go-fonts-g/fonts/gooddogregular"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from gooddogregular"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "gooddogregular", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
