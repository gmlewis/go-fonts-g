...
import (
  ...
  _ "github.com/gmlewis/go-fonts-g/fonts/genzschetheysealternate"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from genzschetheysealternate"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "genzschetheysealternate", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
