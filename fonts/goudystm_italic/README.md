...
import (
  ...
  _ "github.com/gmlewis/go-fonts-g/fonts/goudystm_italic"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from goudystm_italic"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "goudystm_italic", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
