...
import (
  ...
  _ "github.com/gmlewis/go-fonts-g/fonts/greatvibes_regular"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from greatvibes_regular"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "greatvibes_regular", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
