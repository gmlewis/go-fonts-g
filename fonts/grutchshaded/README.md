...
import (
  ...
  _ "github.com/gmlewis/go-fonts-g/fonts/grutchshaded"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from grutchshaded"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "grutchshaded", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
