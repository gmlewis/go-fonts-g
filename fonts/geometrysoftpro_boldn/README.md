...
import (
  ...
  _ "github.com/gmlewis/go-fonts-g/fonts/geometrysoftpro_boldn"
)

func main() {
  // ...
  xPos, yPos, xScale, yScale := 0.0, 0.0, 1.0, 1.0
  message := "Sample from geometrysoftpro_boldn"
  render, err := fonts.Text(xPos, yPos, xScale, yScale, message, "geometrysoftpro_boldn", &fonts.Center)
  if err != nil {
    log.Fatal(err)
  }
